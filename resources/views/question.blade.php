    ...
    <section class="container my-3">
      ...
      <script>
          document.addEventListener('DOMContentLoaded', function () {
            if (!sessionStorage.getItem('isRefreshAfterLike')) {
              restoreScrollPosition();
            } else {
              sessionStorage.removeItem('isRefreshAfterLike'); // Hapus tanda setelah mengembalikan posisi scroll
            }
          });
        ...
        function saveScrollPositionForLike() {
          sessionStorage.setItem('scrollPositionForLike', window.scrollY);
        }

        function restoreScrollPosition() {
          var scrollPositionForLike = sessionStorage.getItem('scrollPositionForLike');
          if (scrollPositionForLike !== null) {
            window.scrollTo(0, parseInt(scrollPositionForLike));
            sessionStorage.removeItem('scrollPositionForLike');
          }
        }
